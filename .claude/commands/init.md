...
- command_surface: Claude Code plugin command /diayn:init
...
- First action required: invoke the native Skill tool with skill: "diayn:diayn-init".
- Unless Validation Probe Mode applies, the first action must be a native Skill tool invocation with skill: "diayn:diayn-init".
