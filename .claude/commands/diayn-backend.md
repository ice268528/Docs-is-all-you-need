---
description: Execute one DIAYN backend lane task slice and stop at candidate_done.
---
...
- First action required: invoke the native Skill tool with skill: "docs-is-all-you-need:diayn-backend".
- Unless Validation Probe Mode applies, the first action must be a native Skill tool invocation with skill: "docs-is-all-you-need:diayn-backend".
