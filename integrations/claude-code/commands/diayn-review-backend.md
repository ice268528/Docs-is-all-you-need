---
description: Review one backend candidate report and decide done or rejected.
---

# DIAYN Review Backend

Role: Backend Review Session.

Treat `$ARGUMENTS` as the user-pasted latest backend worker report. If it is missing, stop.
...
3. Follow `docs/meta/diayn_commands/review_backend.md`.
