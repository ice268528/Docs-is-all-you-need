...
skills:
  - skills/multi-session-controller/SKILL.md
  - skills/multi-session-executor/SKILL.md
  - skills/multi-session-reviewer/SKILL.md
  - skills/multi-session-integrator/SKILL.md
  - skills/session-identity-guard/SKILL.md
  - skills/owner-decision-ux/SKILL.md
  - skills/context-compact-reminder/SKILL.md
scaffold_assets:
  - docs/meta/
  - docs/templates/
  - .diayn/
