...
- First action required: invoke the native Skill tool with skill: "docs-is-all-you-need:diayn-integration".
- Unless Validation Probe Mode applies, the first action must be a native Skill tool invocation with skill: "docs-is-all-you-need:diayn-integration".
