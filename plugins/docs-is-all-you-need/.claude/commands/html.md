...
- command_surface: Claude Code plugin command /diayn:html
...
- First action required: invoke the native Skill tool with skill: "diayn:diayn-html".
- Unless Validation Probe Mode applies, the first action must be a native Skill tool invocation with skill: "diayn:diayn-html".
