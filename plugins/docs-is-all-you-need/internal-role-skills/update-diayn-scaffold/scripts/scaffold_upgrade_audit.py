...
CORE_ARTIFACTS = [
    ...
    ("docs/lanes/backend/evidence.md", "lane", "backend evidence"),
    ("docs/lanes/backend/worklog.md", "lane", "backend worklog"),
    ("docs/lanes/backend/review_log.md", "lane", "backend review log"),
    ("docs/lanes/frontend/board.md", "lane", "frontend lane board"),
    ("docs/lanes/frontend/handoff.md", "lane", "frontend handoff"),
    ("docs/lanes/frontend/evidence.md", "lane", "frontend evidence"),
    ("docs/lanes/frontend/worklog.md", "lane", "frontend worklog"),
    ("docs/lanes/frontend/review_log.md", "lane", "frontend review log"),
