...
- First action required: invoke the native Skill tool with skill: "diayn-review-frontend".
- Unless Validation Probe Mode applies, the first action must be a native Skill tool invocation with skill: "diayn-review-frontend".
