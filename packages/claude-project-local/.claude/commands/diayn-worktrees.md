...
- command_surface: Claude Code project-local fallback command /diayn-worktrees
...
- First action required: invoke the native Skill tool with skill: "diayn-worktrees".
- Unless Validation Probe Mode applies, the first action must be a native Skill tool invocation with skill: "diayn-worktrees".
